   ...
   {links != null ? (
    <>
     <button 
        ...
        className="hover:underline focus:underline py-[0.2rem] px-[2rem] transition-opacity inline-flex items-center bg-transparent cursor-pointer w-full border-none uppercase text-left"
     >
      {sectionTitle}<svg className="w-4 h-4 ml-1 mb-[0.2rem]" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clipRule="evenodd"></path></svg>
     </button>
     <Dropdown 
        links={links}
        dropdown={dropdown}
